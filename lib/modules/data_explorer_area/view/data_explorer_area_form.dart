...
class DataExplorerAreaForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocListener<DataExplorerAreaCubit, DataExplorerAreaState>(
      listener: (context, state) {
        if (state.status == DataExplorerAreaStatus.error) {
          ScaffoldMessenger.of(context)
            ..hideCurrentSnackBar()
            ..showSnackBar(SnackBar(content: Text("${state.errorMessage}")));
        }
      },
      child: BlocBuilder<DataExplorerAreaCubit, DataExplorerAreaState>(
        builder: (context, state) => (state.status == DataExplorerAreaStatus.loading) ?
        ...
        WillPopScope(
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  TopInfoDisplay(topText: state.selectArea.areaName, bottomText1: "", bottomText2: ""),
                  //filtering
                  _FilterOption(),
                  SizedBox(height: 40,),
...
class _PieChart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerAreaCubit, DataExplorerAreaState>(builder: (context, state) {
              ...
              Column(
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3, child: DropdownButton(
                          ...
                          onChanged: (value) => context.read<DataExplorerAreaCubit>().changeSelectYear(year: '$value'),
                        ),),
                      ],
                    ),
                    width: MediaQuery.of(context).size.width*0.4,
                  ...
                  display ? Container() : Container(
                    child: Text("${"Label_dataExplorer_area_PieChart_legend_japan".tr()}:", style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
                  ...
                  SizedBox(height: 10,),
                  display ? Container() : Container(
                    child: Text("${"Label_dataExplorer_area_PieChart_legend_area".tr()} ${state.selectArea.areaName}:", style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
...
class _RawNumberBarChart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerAreaCubit, DataExplorerAreaState>(
        ...
        return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text('${"Label_dataExplorer_area_RawNumberBarChart_title_head".tr()} ${state.selectArea.areaName}${"Label_dataExplorer_area_RawNumberBarChart_title_back".tr()}', style: Theme.of(context).textTheme.caption,),
        ...
        return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text('Label_dataExplorer_area_PercentageBarChart_title'.tr(), style: Theme.of(context).textTheme.caption,),
                SizedBox(height: 20,),
                Container(
                  height: MediaQuery.of(context).size.height*0.2,
                  width: MediaQuery.of(context).size.width*0.9,
        ...
        return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text('susceptibilityRate'.tr(), style: Theme.of(context).textTheme.caption,),
                SizedBox(height: 10,),
                Indicator(color: Colors.redAccent, text: '${state.selectArea.areaName}', isSquare: false),
                Indicator(color: Colors.blueAccent, text: "Label_dataExplorer_area_SusceptibilityLineChart_legend_All".tr(), isSquare: false),
                SizedBox(height: 20,),
                Container(
                  height: MediaQuery.of(context).size.height*0.2,
                  width: MediaQuery.of(context).size.width*0.9,
...
class _FilterOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerAreaCubit, DataExplorerAreaState>(
      builder: (context, state) => (state.status == DataExplorerAreaStatus.loading) ? Container(): Container(
        padding: const EdgeInsets.symmetric(horizontal: 10.0),
        child: Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20),
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (AreaAPI? value){
                            context.read<DataExplorerAreaCubit>().changeArea(selectArea: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerAreaCubit>().changeSpecimenType(specimenId: '$value');
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (FungiType? value){
                            context.read<DataExplorerAreaCubit>().changeFungiType(selectFungi: value!);
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (DrugType? value){
                            context.read<DataExplorerAreaCubit>().changeDrugType(selectDrug: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.origin,
                          onChanged: (value){
                            context.read<DataExplorerAreaCubit>().changeOrigin(origin: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.sex,
                          onChanged: (value){
                            context.read<DataExplorerAreaCubit>().changeSex(sex: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerAreaCubit>().changeAgeGroup(ageGroup: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.bedSize,
                          onChanged: (value){
                            context.read<DataExplorerAreaCubit>().changeBedSize(bedSize: '$value');
                          },
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: RoundedLoadingButton(
                        ...
                        onPressed: (){
                          context.read<DataExplorerAreaCubit>().getTSList();
                        },
