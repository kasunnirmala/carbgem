part of 'data_explorer_area_cubit.dart';
enum DataExplorerAreaStatus {loading, initial, success, error}
class DataExplorerAreaState extends Equatable{
  ...
  final DataExplorerAreaStatus status;
  final String errorMessage;
  final int currentTotal;

  const DataExplorerAreaState({
    this.dataList = const [], this.status = DataExplorerAreaStatus.initial,
  ...
  DataExplorerAreaState copyWith({
    List<Antibiogram>? dataList, DataExplorerAreaStatus? status, String? errorMessage,
