part of 'data_explorer_age_cubit.dart';
enum DataExplorerAgeStatus {loading, initial, success, error}
class DataExplorerAgeState extends Equatable{
  ...
  final DataExplorerAgeStatus status;
  final String errorMessage;
  final int currentTotal;

  const DataExplorerAgeState({
    this.dataList = const [], this.status = DataExplorerAgeStatus.initial,
    ...
    this.origin="ALL", this.ageGroup="35<44", this.selectArea =AreaAPI.empty,
    this.currentTotal=0,
  });
  ...
  DataExplorerAgeState copyWith({
    List<Antibiogram>? dataList, DataExplorerAgeStatus? status, String? errorMessage,
