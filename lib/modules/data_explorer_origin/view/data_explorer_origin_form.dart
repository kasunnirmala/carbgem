...
import '../data_explorer_origin.dart';
class DataExplorerOriginForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocListener<DataExplorerOriginCubit, DataExplorerOriginState>(
      listener: (context, state) {
        if (state.status == DataExplorerOriginStatus.error) {
          ScaffoldMessenger.of(context)
            ..hideCurrentSnackBar()
            ..showSnackBar(SnackBar(content: Text("${state.errorMessage}")));
        }
      },
      child: BlocBuilder<DataExplorerOriginCubit, DataExplorerOriginState>(
        builder: (context, state) => (state.status == DataExplorerOriginStatus.loading) ?
        ...
        WillPopScope(
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  TopInfoDisplay(topText: state.origin =="HO" ? "inpatient".tr():"outpatient".tr(), bottomText1: "", bottomText2: ""),
                  //filtering
                  _FilterOption(),
                  SizedBox(height: 40,),
...
class _PieChart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerOriginCubit, DataExplorerOriginState>(builder: (context, state) {
              ...
              Column(
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3, child: DropdownButton(
                          ...
                          onChanged: (value) => context.read<DataExplorerOriginCubit>().changeSelectYear(year: '$value'),
                        ),),
                      ],
                    ),
                    width: MediaQuery.of(context).size.width*0.4,
                  ...
                  display ? Container() : Container(
                    child: Text("Label_dataExplorer_origin_allPatient".tr(), style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
                  ...
                  SizedBox(height: 10,),
                  display ? Container() : Container(
                    child: Text(state.origin=='HO'? 'inpatient'.tr() : 'outpatient'.tr(), style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
...
class _RawNumberBarChart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerOriginCubit, DataExplorerOriginState>(
        ...
        return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text(state.origin=='HO' ? 'Label_dataExplorer_origin_RawNumberBarChart_inpatient'.tr() : 'Label_dataExplorer_origin_RawNumberBarChart_outpatient'.tr(), style: Theme.of(context).textTheme.caption,),
                Text('Unit: $baseUnit', style: Theme.of(context).textTheme.caption,),
                SizedBox(height: 60,),
                Container(
          ...
          return Container(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  SizedBox(height: 20,),
                  Text(state.origin=='HO' ? 'Label_dataExplorer_origin_PercentageBarChart_inpatient'.tr() : 'Label_dataExplorer_origin_PercentageBarChart_outpatient'.tr(), style: Theme.of(context).textTheme.caption,),
                  SizedBox(height: 20,),
                  Container(
                    height: MediaQuery.of(context).size.height*0.2,
                    width: MediaQuery.of(context).size.width*0.9,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                Indicator(color: Colors.redAccent, text: state.origin=='HO' ? 'inpatient'.tr() : 'outpatient'.tr(), isSquare: false),
                Indicator(color: Colors.blueAccent, text: "Label_dataExplorer_origin_SusceptibilityLineChart_legend_All".tr(), isSquare: false),
                SizedBox(height: 20,),
                Container(
                  height: MediaQuery.of(context).size.height*0.2,
                  width: MediaQuery.of(context).size.width*0.9,
...
class _FilterOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerOriginCubit, DataExplorerOriginState>(
      builder: (context, state) => (state.status == DataExplorerOriginStatus.loading) ? Container(): Container(
        padding: const EdgeInsets.symmetric(horizontal: 10.0),
        child: Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20),
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (AreaAPI? value){
                            context.read<DataExplorerOriginCubit>().changeArea(selectArea: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerOriginCubit>().changeSpecimenType(specimenId: '$value');
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (FungiType? value){
                            context.read<DataExplorerOriginCubit>().changeFungiType(selectFungi: value!);
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (DrugType? value){
                            context.read<DataExplorerOriginCubit>().changeDrugType(selectDrug: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.origin,
                          onChanged: (value){
                            context.read<DataExplorerOriginCubit>().changeOrigin(origin: '$value');
                          },
                          items: patientTypeList.sublist(1,3).map((e) {
                            return DropdownMenuItem(
                              value: e['code'],
                              child: Text(e['value'], style: Theme.of(context).textTheme.caption),
                            );
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.sex,
                          onChanged: (value){
                            context.read<DataExplorerOriginCubit>().changeSex(sex: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerOriginCubit>().changeAgeGroup(ageGroup: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.bedSize,
                          onChanged: (value){
                            context.read<DataExplorerOriginCubit>().changeBedSize(bedSize: '$value');
                          },
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: (){
                        context.read<DataExplorerOriginCubit>().getTSList();
                      },
