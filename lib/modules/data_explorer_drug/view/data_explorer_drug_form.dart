...
class DataExplorerDrugForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocListener<DataExplorerDrugCubit, DataExplorerDrugState>(
      listener: (context, state) {
        if (state.status == DataExplorerDrugStatus.error) {
          ScaffoldMessenger.of(context)
            ..hideCurrentSnackBar()
            ..showSnackBar(SnackBar(content: Text("${state.errorMessage}")));
        }
      },
      child: BlocBuilder<DataExplorerDrugCubit, DataExplorerDrugState>(
        builder: (context, state) => (state.status == DataExplorerDrugStatus.loading) ?
        ...
        WillPopScope(
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  TopInfoDisplay(topText: state.selectDrug.drugName, bottomText1: "${"whoAware".tr()}: ${state.selectDrug.whoAware}", bottomText2: ""),
                  //filtering
                  _FilterOption(),
                  SizedBox(height: 40,),
...
class _PieChart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerDrugCubit, DataExplorerDrugState>(builder: (context, state) {
              ...
              Column(
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3, child: DropdownButton(
                          ...
                          onChanged: (value) => context.read<DataExplorerDrugCubit>().changeSelectYear(year: '$value'),
                        ),),
                      ],
                    ),
                    width: MediaQuery.of(context).size.width*0.4,
                  ...
                  display ? Container() : Container(
                    child: Text("${"Label_dataExplorer_drug_PieChart_legend_middle".tr()} ${state.selectFungi.fungiName}:", style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
                  ...
                  SizedBox(height: 10,),
                  display ? Container() : Container(
                    child: Text("${"Label_dataExplorer_drug_PieChart_legend_bottom_head".tr()} ${state.selectDrug.drugName}${"Label_dataExplorer_drug_PieChart_legend_bottom_back".tr()}:", style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
...
class _RawNumberBarChart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerDrugCubit, DataExplorerDrugState>(
        ...
        return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text('${"Label_dataExplorer_drug_RawNumberBarChart_title_head".tr()} ${state.selectDrug.drugName}${"Label_dataExplorer_drug_RawNumberBarChart_title_back".tr()}', style: Theme.of(context).textTheme.caption,),
          ...
          return Container(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  SizedBox(height: 20,),
                  Text('${"Label_dataExplorer_drug_PercentageBarChart_title_head".tr()} ${state.selectFungi.fungiName}${"Label_dataExplorer_drug_PercentageBarChart_title_back".tr()}', style: Theme.of(context).textTheme.caption,),
                  SizedBox(height: 20,),
                  Container(
                    height: MediaQuery.of(context).size.height*0.2,
                    width: MediaQuery.of(context).size.width*0.9,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Container(
                  child: Text('${"susceptibilityRate".tr()}: ${state.selectFungi.fungiName}', style: Theme.of(context).textTheme.caption,),
                  width: MediaQuery.of(context).size.width*0.8,
                ),
                SizedBox(height: 10,),
                Indicator(color: Colors.redAccent, text: '${state.selectDrug.drugName}', isSquare: false),
                Indicator(color: Colors.blueAccent, text: "Label_dataExplorer_drug_SusceptibilityLineChart_legend_All".tr(), isSquare: false),
                SizedBox(height: 20,),
                Container(
                  height: MediaQuery.of(context).size.height*0.2,
                  width: MediaQuery.of(context).size.width*0.9,
...
class _FilterOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerDrugCubit, DataExplorerDrugState>(
      builder: (context, state) => (state.status == DataExplorerDrugStatus.loading) ? Container(): Container(
        padding: const EdgeInsets.symmetric(horizontal: 10.0),
        child: Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20),
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (AreaAPI? value){
                            context.read<DataExplorerDrugCubit>().changeArea(selectArea: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerDrugCubit>().changeSpecimenType(specimenId: '$value');
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (FungiType? value){
                            context.read<DataExplorerDrugCubit>().changeFungiType(selectFungi: value!);
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (DrugType? value){
                            context.read<DataExplorerDrugCubit>().changeDrugType(selectDrug: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.origin,
                          onChanged: (value){
                            context.read<DataExplorerDrugCubit>().changeOrigin(origin: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.sex,
                          onChanged: (value){
                            context.read<DataExplorerDrugCubit>().changeSex(sex: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerDrugCubit>().changeAgeGroup(ageGroup: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.bedSize,
                          onChanged: (value){
                            context.read<DataExplorerDrugCubit>().changeBedSize(bedSize: '$value');
                          },
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: (){
                        context.read<DataExplorerDrugCubit>().getTSList();
                      },
