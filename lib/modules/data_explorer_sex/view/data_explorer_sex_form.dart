...
class DataExplorerSexForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocListener<DataExplorerSexCubit, DataExplorerSexState>(
      listener: (context, state) {
        if (state.status == DataExplorerSexStatus.error) {
          ScaffoldMessenger.of(context)
            ..hideCurrentSnackBar()
            ..showSnackBar(SnackBar(content: Text("${state.errorMessage}")));
        }
      },
      child: BlocBuilder<DataExplorerSexCubit, DataExplorerSexState>(
        builder: (context, state) => (state.status == DataExplorerSexStatus.loading) ?
        ...
        WillPopScope(
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  TopInfoDisplay(topText: state.sex=='M' ? 'male'.tr() : 'female'.tr(), bottomText1: "", bottomText2: ""),
                  //filtering
                  _FilterOption(),
                  SizedBox(height: 40,),
...
class _PieChart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerSexCubit, DataExplorerSexState>(builder: (context, state) {
              ...
              Column(
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3, child: DropdownButton(
                          ...
                          onChanged: (value) => context.read<DataExplorerSexCubit>().changeSelectYear(year: '$value'),
                        ),),
                      ],
                    ),
                    width: MediaQuery.of(context).size.width*0.4,
                  ...
                  display ? Container() : Container(
                    child: Text("Label_dataExplorer_sex_PieChart_all".tr(), style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
                  ...
                  SizedBox(height: 10,),
                  display ? Container() : Container(
                    child: Text(state.sex=='M'? 'male'.tr() : 'female'.tr(), style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
...
class _RawNumberBarChart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerSexCubit, DataExplorerSexState>(
        ...
        return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text(state.sex=='M' ? 'Label_dataExplorer_sex_RawNumberBarChart_male'.tr() : 'Label_dataExplorer_sex_RawNumberBarChart_female'.tr(), style: Theme.of(context).textTheme.caption,),
          ...
          return Container(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  SizedBox(height: 20,),
                  Text(state.sex=='M' ? 'Label_dataExplorer_sex_PercentageBarChart_male'.tr() : 'Label_dataExplorer_sex_PercentageBarChart_female'.tr(), style: Theme.of(context).textTheme.caption,),
                  SizedBox(height: 20,),
                  Container(
                    height: MediaQuery.of(context).size.height*0.2,
                    width: MediaQuery.of(context).size.width*0.9,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                Indicator(color: Colors.redAccent, text: state.sex=='M' ? 'male'.tr() : 'female'.tr(), isSquare: false),
                Indicator(color: Colors.blueAccent, text: "Label_dataExplorer_sex_SusceptibilityLineChart_legend_All".tr(), isSquare: false),
                SizedBox(height: 20,),
                Container(
                  height: MediaQuery.of(context).size.height*0.2,
                  width: MediaQuery.of(context).size.width*0.9,
...
class _FilterOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerSexCubit, DataExplorerSexState>(
      builder: (context, state) => (state.status == DataExplorerSexStatus.loading) ? Container(): Container(
        padding: const EdgeInsets.symmetric(horizontal: 10.0),
        child: Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20),
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (AreaAPI? value){
                            context.read<DataExplorerSexCubit>().changeArea(selectArea: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerSexCubit>().changeSpecimenType(specimenId: '$value');
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (FungiType? value){
                            context.read<DataExplorerSexCubit>().changeFungiType(selectFungi: value!);
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (DrugType? value){
                            context.read<DataExplorerSexCubit>().changeDrugType(selectDrug: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.origin,
                          onChanged: (value){
                            context.read<DataExplorerSexCubit>().changeOrigin(origin: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.sex,
                          onChanged: (value){
                            context.read<DataExplorerSexCubit>().changeSex(sex: '$value');
                          },
                          items: patientSexList.sublist(1,3).map((e) {
                            return DropdownMenuItem(
                              value: e['code'],
                              child: Text(e['value'], style: Theme.of(context).textTheme.caption),
                            );
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerSexCubit>().changeAgeGroup(ageGroup: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.bedSize,
                          onChanged: (value){
                            context.read<DataExplorerSexCubit>().changeBedSize(bedSize: '$value');
                          },
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: (){
                        context.read<DataExplorerSexCubit>().getTSList();
                      },
