part of 'data_explorer_sex_cubit.dart';
enum DataExplorerSexStatus {loading, initial, success, error}
class DataExplorerSexState extends Equatable{
  ...
  final DataExplorerSexStatus status;
  final String errorMessage;
  final int currentTotal;

  const DataExplorerSexState({
    this.dataList = const [], this.status = DataExplorerSexStatus.initial,
    ...
    this.specimenId = "1", this.year = "", this.bedSize = "ALL", this.sex = "M",
  ...
  DataExplorerSexState copyWith({
    List<Antibiogram>? dataList, DataExplorerSexStatus? status, String? errorMessage,
