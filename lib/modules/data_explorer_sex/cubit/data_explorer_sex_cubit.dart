...
part 'data_explorer_sex_state.dart';
class DataExplorerSexCubit extends Cubit<DataExplorerSexState> {
  final AuthenticationRepository _authenticationRepository;
  final BitteApiClient _bitteApiClient;

  DataExplorerSexCubit(this._authenticationRepository, this._bitteApiClient): super(DataExplorerSexState()){
    initiation();
  }
  Future<void> initiation() async{
    emit(state.copyWith(status: DataExplorerSexStatus.loading));
    ...
    List<Antibiogram> dataList = await _bitteApiClient.getBreakdownSexAPI(
    ...
    emit(state.copyWith(
      ...
      status: DataExplorerSexStatus.success, dataList: dataList,
    ),);
  }
  Future<void> getTSList() async {
    ...
    emit(state.copyWith(dataList: dataList, status: DataExplorerSexStatus.success));
  }
  Future<void> changeSpecimenType({required String specimenId}) async {
    ...
    emit(state.copyWith(
      ...
      status: DataExplorerSexStatus.success,
    ),);
  }
  ...
  Future<void> changeArea({required AreaAPI selectArea}) async {
    ...
    emit(state.copyWith(dataList: dataList, selectArea: selectArea, status: DataExplorerSexStatus.success));
  }
