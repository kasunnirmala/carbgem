part of 'data_explorer_size_cubit.dart';
enum DataExplorerSizeStatus {loading, initial, success, error}
class DataExplorerSizeState extends Equatable{
  ...
  final DataExplorerSizeStatus status;
  final String errorMessage;
  final int currentTotal;

  const DataExplorerSizeState({
    this.dataList = const [], this.status = DataExplorerSizeStatus.initial,
    ...
    this.specimenId = "1", this.year = "", this.bedSize = "<200", this.sex = "ALL",
  ...
  DataExplorerSizeState copyWith({
    List<Antibiogram>? dataList, DataExplorerSizeStatus? status, String? errorMessage,
