...
class DataExplorerSizeForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocListener<DataExplorerSizeCubit, DataExplorerSizeState>(
      listener: (context, state) {
        if (state.status == DataExplorerSizeStatus.error) {
          ScaffoldMessenger.of(context)
            ..hideCurrentSnackBar()
            ..showSnackBar(SnackBar(content: Text("${state.errorMessage}")));
        }
      },
      child: BlocBuilder<DataExplorerSizeCubit, DataExplorerSizeState>(
        builder: (context, state) => (state.status == DataExplorerSizeStatus.loading) ?
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  TopInfoDisplay(
                      topText: state.bedSize == "<200" ? "Label_dataExplorer_size_less".tr() :
                      (state.bedSize == "500<=" ? "Label_dataExplorer_size_atLeast".tr() : "Label_dataExplorer_size_toFrom".tr()),
...
class _PieChart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerSizeCubit, DataExplorerSizeState>(builder: (context, state) {
              ...
              Column(
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3, child: DropdownButton(
                          ...
                          onChanged: (value) => context.read<DataExplorerSizeCubit>().changeSelectYear(year: '$value'),
                        ),),
                      ],
                    ),
                    width: MediaQuery.of(context).size.width*0.4,
                  ...
                  display ? Container() : Container(
                    child: Text("Label_dataExplorer_size_pieChart_all".tr(), style: Theme.of(context).textTheme.caption,),
                    width: MediaQuery.of(context).size.width*0.4,
                  ),
                  display ? Container() : Container(
                  ...
                  SizedBox(height: 10,),
                  display ? Container() : Container(
                    child: Text(state.bedSize=='<200'? 'Label_dataExplorer_size_less'.tr() : (state.bedSize == "500<=" ? "Label_dataExplorer_size_atLeast".tr():"Label_dataExplorer_size_toFrom".tr()),
...
class _RawNumberBarChart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerSizeCubit, DataExplorerSizeState>(
        ...
        return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(height: 20,),
                Text(state.bedSize=='<200' ? 'Label_dataExplorer_size_less'.tr() : (state.bedSize == "500<=" ? 'Label_dataExplorer_size_atLeast'.tr():'Label_dataExplorer_size_toFrom'.tr()),
                  style: Theme.of(context).textTheme.caption,),
          ...
          return Container(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  SizedBox(height: 20,),
                  Text(state.bedSize=='<200' ? 'Label_dataExplorer_size_less'.tr() :
                  (state.bedSize == "500<=" ? "Label_dataExplorer_size_atLeast".tr() : "Label_dataExplorer_size_toFrom".tr()), style: Theme.of(context).textTheme.caption,),
                  SizedBox(height: 20,),
                  Container(
                    height: MediaQuery.of(context).size.height*0.2,
                    width: MediaQuery.of(context).size.width*0.9,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10,),
                Indicator(color: Colors.redAccent,
                    text: state.bedSize=='<200' ? 'Label_dataExplorer_size_less'.tr() : (state.bedSize == "500<=" ? "Label_dataExplorer_size_atLeast".tr() : "Label_dataExplorer_size_toFrom".tr()),
                    isSquare: false),
                Indicator(color: Colors.blueAccent, text: "Label_dataExplorer_size_SusceptibilityLineChart_legend_All".tr(), isSquare: false),
                SizedBox(height: 20,),
                Container(
                  height: MediaQuery.of(context).size.height*0.2,
                  width: MediaQuery.of(context).size.width*0.9,
...
class _FilterOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DataExplorerSizeCubit, DataExplorerSizeState>(
      builder: (context, state) => (state.status == DataExplorerSizeStatus.loading) ? Container(): Container(
        padding: const EdgeInsets.symmetric(horizontal: 10.0),
        child: Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20),
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (AreaAPI? value){
                            context.read<DataExplorerSizeCubit>().changeArea(selectArea: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerSizeCubit>().changeSpecimenType(specimenId: '$value');
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (FungiType? value){
                            context.read<DataExplorerSizeCubit>().changeFungiType(selectFungi: value!);
                          },
                      ...
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (DrugType? value){
                            context.read<DataExplorerSizeCubit>().changeDrugType(selectDrug: value!);
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.origin,
                          onChanged: (value){
                            context.read<DataExplorerSizeCubit>().changeOrigin(origin: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.sex,
                          onChanged: (value){
                            context.read<DataExplorerSizeCubit>().changeSex(sex: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          ...
                          onChanged: (value){
                            context.read<DataExplorerSizeCubit>().changeAgeGroup(ageGroup: '$value');
                          },
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(flex: 3,child: DropdownButton(
                          value: state.bedSize,
                          onChanged: (value){
                            context.read<DataExplorerSizeCubit>().changeBedSize(bedSize: '$value');
                          },
                          items: bedSizeList.sublist(1, 4).map((e) {
                            return DropdownMenuItem(
                              value: e['code'],
                              child: Text(e['value'], style: Theme.of(context).textTheme.caption),
                            );
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: RoundedLoadingButton(
                      ...
                      onPressed: (){
                        context.read<DataExplorerSizeCubit>().getTSList();
                      },
